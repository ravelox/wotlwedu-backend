...
// Add category
router.post("/", Security.checkCapability("category",["add"]), categoryController.putAddCategory);
...
// Edit a category
router.put("/:categoryId", Security.checkCapability("category",["edit"]), categoryController.postUpdateCategory);
